  ...
  <tr>
    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        <tbody> 
        <tr> 
          <td height="300" valign="top" width="651"><form name="form1" method="post" action="HotelAdmin1.jsp">
          <fieldset>
          <legend><strong>HOTEL FORM</strong></legend>
            <table width="294" border="0" align="center">
              <tr>
                <td width="89"><strong>Hotel Id </strong></td>
                <td width="195"><label>
   ...
   <tr>
              ...
              <tr>
			   ...
			   <tr>
                <td><strong>NoofRooms</strong></td>
                <td><input type="text" name="rooms" id="rooms"></td>
              </tr>
             
               <tr>
                <td><strong>RoomType1</strong></td>
                <td><input type="text" name="roomtype1" id="roomtype1"></td>
              </tr>
             <tr>
                <td><strong>RoomType1Cost</strong></td>
                <td><input type="text" name="roomtype1cost" id="roomtype1cost"></td>
              </tr>
             <tr>
                <td><strong>RoomType2</strong></td>
                <td><input type="text" name="roomtype2" id="roomtype2"></td>
              </tr>
             <tr>
                <td><strong>RoomType2cost</strong></td>
                <td><input type="text" name="roomtype2cost" id="roomtype2cost"></td>
              </tr>
             <tr>
                <td><strong>RoomType3</strong></td>
                <td><input type="text" name="roomtype3" id="roomtype3"></td>
              </tr>
             <tr>
                <td><strong>RoomType3Cost</strong></td>
                <td><input type="text" name="roomtype3cost" id="roomtype3cost"></td>
              </tr>
                  <tr>
                <td colspan="4"><div align="center">
                  <input type="submit" name="AddHotels" value="Insert">&nbsp;
                       <input type="submit" name="updateHotels" value="Update"/>  &nbsp;              
                  <input type="submit" name="deleteHotels" value="Delete"/>&nbsp;<a href="AdminviewHotels.jsp"><strong><font color=blue>ViewHotels</font></strong></a>
                </div></td>
                </tr>
			  </table>
            </fieldset>
