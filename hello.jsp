    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        ...
        <tr> 
          ...
          <fieldset>
          <legend><strong><font color=blue>ADMINMODULE</font></strong></legend>
            <table width="294" border="0" align="center">
              <tr>
                <td width="89"><strong><a href="hoteladmin.jsp"><FONT Color="blue">ADDHOTELS</FONT></a></strong></td>
                 </tr>
              <tr>
                <td><strong><a href="Transportadmin.jsp"><FONT Color="blue">ADDTRANSPORT</FONT></a></strong></td>
             </tr>
              <tr>
                <td><strong><a href="TourLocationsadmin.jsp"><FONT Color="blue">ADDTOURLOCATIONS</FONT></a></strong></td>
                 </tr>
              <tr>
                <td><strong><a href="Theateradmin.jsp"><FONT Color="blue">ADDTHEATERS</FONT></a></strong></td>
               </tr>
              <tr>
                <td><strong><a href="shopadmin.jsp"><FONT Color="blue">ADDSHOPES</FONT></a></strong></td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td>&nbsp;</td>
