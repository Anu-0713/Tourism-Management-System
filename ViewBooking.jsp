...
<table width="102%" height="0" border="1" align="left" cellpadding="0" cellspacing="0">
  <tbody>
  
  <tr>
    <td width="14%" height="320" bgcolor="#993300">&nbsp;</td> 
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="3" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        <tbody> 
        <tr> 
          <td height="300" valign="top" width="651"><form name="form1" method="post" action="AddTransport1.jsp">
          <fieldset>
          <legend><strong>ADD TRANSAPORT</strong></legend>
        <%@ page import="com.dts.core.util.*" %>
        <%@ page import="com.dts.project.dao.*"%>
<%@ page import="com.dts.project.model.*"%><%@page import="java.util.*"%>
        <% HotelBookingDAO ahotelbookingdao=new HotelBookingDAO();
     CoreHash acorehash=ahotelbookingdao.getBookingDetails();
        Enumeration aenumeration=acorehash.keys();
        %>
        <table border="3">
          <tr bordercolor="#660000" bgcolor="#660000"><td><span class="style10">HotelName</span></td>
        <td><span class="style10">Name</span></td>
        <td><span class="style10">MobileNo</span></td>
        <td><span class="style10">Checkin</span></td>
        <td><span class="style10">Checkout</span></td>
        <td><span class="style10">NoOfRooms</span></td>
        <td><span class="style10">TotalCost</span></td>
        </tr>
        <%
        ...
        String hotelname=ahotelprofile.getHotel();
        String fname=ahotelprofile.getFname();
        String mobile=ahotelprofile.getMobile();
        String checkin=ahotelprofile.getCheeckin();
      
       String checkout=ahotelprofile.getCheckout();
       double noofrooms=ahotelprofile.getNoofrooms();
     double totalcost=ahotelprofile.getTotalcost();
      
      
         %>
        <tr bordercolor="#660000"><td><span class="style11"><%=hotelname%></span></td>
        <td><span class="style11"><%=fname%></span></td>
        <td><span class="style11"><%=mobile%></span></td>
        <td><span class="style11"><%=checkin%></span></td>
        <td><span class="style11"><%=checkout%></span></td>
        <td><span class="style11"><%=noofrooms %></span></td>
        <td><span class="style11"><%=totalcost%></span></td>
        </tr>
            <%} %></table>
          </fieldset>
                    </form>
