...
<html>
  <head>
    ...
    <title>My JSP 'AdminShopping.jsp' starting page</title>
...
.style2 {color: #000000}
.style3 {color: #3333FF}
.style6 {color: #660000; font-weight: bold; }
-->
  </style>
  </head>
  ...
  <tr>
    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        <tbody> 
        <tr> 
          <td height="300" valign="top" width="651"><form name="form1" method="post" action="AdminShopping1.jsp">
          <fieldset>
          <legend><strong><font color="blue">ADMIN SHOPPING</font></strong></legend>
            <table width="250" border="0" align="center">
              <tr bordercolor="#660000">
                <td width="95"><span class="style1">Sno</span></td>
                <td width="145"><strong>
                  <label>
              ...
              <tr>
                <td><span class="style6">ShopName</span></td>
              ...
              <tr>
                <td><span class="style6">Famous</span></td>
				
                <td><input type="text" name="famous" id="famous"></td>
              </tr>
              <tr>
                <td><span class="style6">Discount</span></td>
                <td><input type="text" name="discount" id="discount"></td>
              </tr>
              </table>
            <input type="submit" name="Shopdelete" value="Shopdelete"/>
            <input type="submit" name="ShopInsert" value="ShopInserting"/>
            
            <input type="submit" name="ShopUpdate" value="ShopUpdate"/>
            <a href="AdminViewShoppie.jsp"><font color="blue">ViewShoppes</font></a>
          </fieldset>
                    </form>          </td>
          </tr>
        </tbody> 
