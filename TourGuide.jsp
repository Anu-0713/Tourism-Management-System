    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        ...
        <tr> 
          ...
          <fieldset>
          <legend><strong>Tour Guides</strong></legend>
           
<%@ page import="java.util.*" %>
 <%@ page import="com.dts.project.dao.*"%>
<%@ page import="com.dts.project.model.*"%><%@ page import="com.dts.core.util.*" %>  
<% TourGuideDAO atourguidedao=new TourGuideDAO();
String  city=request.getParameter("city");
  if(city==null){
city=(String)application.getAttribute("city");
}
 
CoreHash aCoreHash=atourguidedao.viewTourGuides(city);
Enumeration aenumeration=aCoreHash.keys();
out.println("<table border='1' width='100%'><tr><td><font color=blue>FirstName</font></td><td><font color=blue>LstName</font></td><td><font color=blue>City</font></td><td><font color=blue>Phno</font></td><td><font color=blue>Email</font></td><td><font color=blue>Languages</font></td><td><font color=blue>Status</font></td></tr>");

while(aenumeration.hasMoreElements())
{
Integer i1=(Integer)aenumeration.nextElement();
TourGuideModel atourguidemodel=(TourGuideModel)aCoreHash.get(i1);
out.println("<tr><td>");
out.println(atourguidemodel.getFirstname());out.println("</td><td>");
out.println(atourguidemodel.getLastname());out.println("</td><td>");
out.println(atourguidemodel.getAddress());out.println("</td><td>");
out.println(atourguidemodel.getPhno());out.println("</td><td>");
out.println(atourguidemodel.getEmailid());out.println("</td><td>");
out.println(atourguidemodel.getLanguage());out.println("</td><td>");
out.println(atourguidemodel.getStatus());out.println("</td></tr>");
}
out.println("</table>");
%> 

<A href="TourisumLocations.jsp">Home</A>
