...
<%@ page import="com.dts.project.model.*"%><%@page import="java.util.*"%>
        <% TransportDAO ahotelbookingdao=new TransportDAO();
     CoreHash acorehash=ahotelbookingdao.viewAllTransportBooking();
    
        Enumeration aenumeration=acorehash.keys();
        %>
        <table border="3">
          <tr bordercolor="#660000" bgcolor="#660000">
        <td width="79"><span class="style10">Loginname</span></td>
        <td width="100"><span class="style10">FirstName</span></td>
        <td width="118"><span class="style10">LastName</span></td>
        <td width="81"><span class="style10">CarName</span></td>
        <td width="89"><span class="style10">NoOfDays</span></td>
        <td width="130"><span class="style10">TotalCost</span></td>
        </tr>
        <%
        while(aenumeration.hasMoreElements())
        {
        Integer i1=(Integer)aenumeration.nextElement();
        TransportModel atransport=(TransportModel)acorehash.get(i1);
        String loginname=atransport.getLoginname();
        String fname=atransport.getFirstname();
        String lname=atransport.getLastname();
        String carname=atransport.getCarname();
      
      double days=atransport.getDays();
         double totalcost=atransport.getTotalcost();
      
      
         %>
        <tr bordercolor="#660000"><td><span class="style11"><%=loginname%></span></td>
        <td><span class="style11"><%=fname%></span></td>
        <td><span class="style11"><%=lname%></span></td>
        <td><span class="style11"><%=carname%></span></td>
        <td><span class="style11"><%=days%></span></td>
