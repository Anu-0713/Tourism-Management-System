...
<table width="102%" height="0" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        <tbody> 
        <tr> 
          <td height="300" valign="top" width="651"><form name="form1" method="post" action="HotelBooking1.jsp">
          <fieldset>
          <legend><strong>LoginForm</strong></legend>
          <%if(request.getParameter("status")!=null)
  { %>
  <font color="blue"><%=request.getParameter("status") %></font>
  <%} %>
  ...
  <%} %>
  <%
  String checkin=(String)session.getAttribute("abc1");
  String checkout=(String)session.getAttribute("abc2");
  
  System.out.println("this is hotelbooking"+checkin);
  System.out.println("this is hotelbooking"+checkout);
  ...
  System.out.println("this is hotelname"+hotelname);
 ...
 <table width="200" border="1">
   ...
   <input type="hidden" name="abc5" value="<%=checkin%>"/>
    <input type="hidden" name="room1" value="<%=room1%>"/>
  
    <input type="hidden" name="abc6" value="<%=checkout%>"/>
     <input type="hidden" name="roomno" value="<%=roomno%>"/>
    <input type="hidden" name="room1cost" value="<%=room1cost%>"/> 
  ...
  <tr>
    <td>Landno</td>
    <td><input type="text" name="landno"/></td>
  </tr>
  <tr>
    <td>MobilePhno</td>
  ...
  <tr>
    <td><input type="submit" name="HotelBooking" value="HotelBooking"/></td>
    <td>&nbsp;</td>
  </tr>
</table>
  </fieldset>
