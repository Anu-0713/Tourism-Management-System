...
<table><tr>
    ...
    aHotelProfile=(HotelProfile)aCoreHash.get(i1);
     ...
     System.out.println(hotelid);
          CoreHash ht=aHotelBookingDAO.getRoomDetails(hotelid,pricerange);  
          

HotelProfile hp=(HotelProfile)ht.get("abc");%>
...
int i=20;
 ...
 %>
 <td><%String Hotel=hp.getHotel();
 out.println(Hotel);%></td>

<td><%String city1=hp.getCity();
out.println(city1);%></td>
<td> <%=room1%></td>
<td> <%=room1cost%></td><td><% out.println("<a href='HotelBooking.jsp?hotelid="+hotelid+"&hotelname="+city1+"&room1="+room1+"&room1cost="+room1cost+"'>RoomBooking</a>");%></td></tr>
<tr>
 <td><%= hp.getHotel()%></td>
...
<td><%=room2 %></td>
<td><%=room2cost %></td><td><% out.println("<a href='HotelBooking.jsp?hotelid="+hotelid+"&hotelname="+city1+"&room1="+room2+"&room1cost="+room2cost+"'>RoomBooking</a>");%></td></tr>
<tr>
 <td><%= hp.getHotel()%></td>
...
<td><%=room3%></td>
<td><%=room3cost %> </td><td><% out.println("<a href='HotelBooking.jsp?hotelid="+hotelid+"&hotelname="+city1+"&room1="+room3+"&room1cost="+room3cost+"'>RoomBooking</a>");%></td></tr> 
<%// store.put("hello",hp); 
//session.setAttribute("hello1",store);
  }else if(room2!=null)
{String hotelname=hp.getHotel();
%><tr><td><%= hp.getHotel()%></td>
<td><%String city1=hp.getCity();
out.println(city1);%></td>
...
<td><%=room2 %></td>
<td><%=room2cost %></td><td><% out.println("<a href='HotelBooking.jsp?hotelid="+hotelid+"&hotelname="+city1+"&room1="+room2+"&room1cost="+room2cost+"'>RoomBooking</a>");%></td></tr>
<%}else{String hotelname=hp.getHotel(); %>
<tr><td><%= hp.getHotel()%></td>

<td><%String city1=hp.getCity();
out.println(city1);%></td>
 
<td> <%=room1%></td><input type="hidden" name="city" value="<%=hotelname%>"/>
<td> <%=room1cost%></td><td><% out.println("<a href='HotelBooking.jsp?hotelid="+hotelid+"&hotelname="+city1+"&room1="+room1+"&room1cost="+room1cost+"'>RoomBooking</a>");%></td></tr>
<%
}
}
