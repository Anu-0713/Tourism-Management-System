    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        ...
        <tr> 
          ...
          <fieldset>
          <legend><strong>Admin view</strong></legend>
           <%@ page import="java.util.*"%>
          <%@ page import="com.dts.project.dao.*"%>
<%@ page import="com.dts.project.model.*"%> <%@ page import="com.dts.core.util.*" %>
       <%   
           
           TransportDAO atansport=new TransportDAO();
  CoreHash acorehash=atansport.viewTransport();
   Enumeration aenumeration=acorehash.keys();%>
  <table width="648" border="1" bordercolor="#660000">
    <tr bgcolor="#660033"><td><span class="style8">City</span></td>
    <td><span class="style8">CarName</span></td>
    <td><span class="style8">CarModel</span></td>
    <td><span class="style8">Cost1day</span></td>
    <td><span class="style8">costhalfday</span></td>
    <td><span class="style8">cost1hr</span></td>
    <td><span class="style8">cost1km</span></td>
    </tr>
  <%	 while(aenumeration.hasMoreElements())
   {
   Integer i1=(Integer)aenumeration.nextElement();
   TransportModel ahotelprofile=(TransportModel)acorehash.get(i1);
String city=ahotelprofile.getCity();
 String carname=ahotelprofile.getCarname();
 String carmodel=ahotelprofile.getCarmodel();
 double cost1day=ahotelprofile.getCost1day();
double costhalfday=ahotelprofile.getCosthalfday();
double cost1hr=ahotelprofile.getCost1hr();
double cost1km=ahotelprofile.getCost1km();
  %><tr bordercolor="#660066"><td>
        		<span class="style9"><%=city%></span></td><td>
        		  <span class="style9"><%=carname%></span></td><td>
        		  
        		   		  <span class="style9"><%=carmodel%></span></td><td>
        		   		  
        		            <span class="style9"><%=cost1day%></span></td><td>
        		  
        		              <span class="style9"><%=costhalfday%></span></td><td>
        		  
        		                <span class="style9"><%=cost1hr%></span></td><td>
        		  
        		                  <span class="style9"><%=cost1km%></span></td><td>
