    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        ...
        <tr> 
          ...
          <fieldset>
          <legend><strong>Selected Rooms </strong></legend>
...
<html>
  <head>
    ...
    <title>My JSP 'HotelBooking1.jsp' starting page</title>
...
<%@ page import="com.dts.project.model.*"%><%@ page import="com.dts.core.util.CoreHash"%>
  <%
    if(request.getParameter("HotelBooking")!=null)
    {
    ...
    String checkout=request.getParameter("abc6");
        System.out.println("this is hotelbooking1asdf"+checkin);

  System.out.println("this is hotelbooking1dfa"+checkout);
...
System.out.println("this is room1cost"+room1cost);
  ...
  boolean flag1=aHotelBookingDAO.addDays(emailid,checkin,checkout);
...
aHotelProfile.setTotalcost(totalcost);
  boolean flag=aHotelBookingDAO.addHotelBooking(aHotelProfile);
   if(flag)
   {
//double days=aHotelBookingDAO.getStayingDays(emailid);
  //  double totalcost=(roomno1*room1cost1)*days;
    ...
    aHotelProfile.setTotalcost(totalcost);
 out.println("<table><tr><td><font color=blue>HotelName</font></td><td><font color=blue>RoomType</font></td><td><font color=blue>roomcost</font></td><td><font color=blue>Roomno</font></td><td><font color=blue>noofdays</font></td><td><font color=blue>TotalCost</font></td></tr>");
   out.println("(<tr><td>");
