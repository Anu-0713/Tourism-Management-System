    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        ...
        <tr> 
          ...
          <fieldset>
          <legend><strong>Welcome To The Theaters</strong></legend>
...
city=(String)application.getAttribute("city");
    ...
    Theaters atourguidedao=new Theaters();
    System.out.println(city);
   CoreHash acorehash= atourguidedao.viewTheaters(city);
    Enumeration aenumeration=acorehash.keys();
  out.println("<table><tr><td><font color=blue>TheaterId</font></td><td><font color=blue>City</font></td><td><font color=blue>TheaterName</font></td><td><font color=blue>CinemaName</font></td><td><font color=blue>MorningShow</font></td><td><font color=blue>MatnyShow</font></td><td><font color=blue>FirstShow</font></td><td><font color=blue>SecondShow</font></td></tr>");
    while(aenumeration.hasMoreElements())
    {
    Integer i1=(Integer)aenumeration.nextElement();
    Enterainement aenterainement= (Enterainement)acorehash.get(i1);
    out.println("<tr><td>");
    out.println(aenterainement.getSno());
out.println("</td><td>");
    out.println(aenterainement.getCity());
out.println("</td><td>");
    out.println(aenterainement.getTheatername());
    out.println("</td><td>");
    out.println(aenterainement.getCenima());out.println("</td><td>");
    out.println(aenterainement.getMorningshow());out.println("</td><td>");
    out.println(aenterainement.getMatnyshow());out.println("</td><td>");
    out.println(aenterainement.getFirstshow());out.println("</td><td>");
    out.println(aenterainement.getSecondshow());out.println("</td></tr>");
