    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        ...
        <tr> 
          ...
          <fieldset>
          <legend><strong>AVAILABLE CARS</strong></legend>
...
<%@ page import="java.util.*" %>
 <%if(request.getParameter("days").equals("Fullday")) 
   { 
   String day=request.getParameter("days");
   String city=request.getParameter("city");
   TransportDAO aTransportDAO=new TransportDAO(); 
  CoreHash aCoreHash=aTransportDAO.getDayCars(day,city); 
    java.util.Enumeration aenumeration=aCoreHash.keys(); 
  
   %>
   <table border="1" width="100%"><TR><td><font color=blue>Carname<font></td><td><font color=blue>CarModel</font></td><td><font color=blue>CostDay</font></td><td><font color=blue>Cost1hr</font></td><td><font color=blue>Cost1km</font></td></TR>

   <%
    while(aenumeration.hasMoreElements()) 
    { 
    Integer i1=(Integer)aenumeration.nextElement();
    TransportModel aTransportmodel=(TransportModel)aCoreHash.get(i1);
    out.println("<tr><td>");
   String carname=aTransportmodel.getCarname();
    out.println(carname);
    out.println("</td>");
 out.println("<td>");
 String carmodel=aTransportmodel.getCarmodel();
     out.println(carmodel);
    out.println("</td>");
    out.println("<td>");
    double cost1day=aTransportmodel.getCost1day();
    out.println(cost1day);
    out.println("</td>");
    out.println("<td>");
double cost1hr=aTransportmodel.getCost1hr();
out.println(cost1hr);
    out.println("</td>");
    out.println("<td>");
double cost1km=aTransportmodel.getCost1km();
out.println(cost1km);
    out.println("</td><td>");
out.println("<a href='TransportBooking.jsp?Carname="+carname+"&carmodel="+carmodel+"&cost1day="+cost1day+"&cost1hr="+cost1hr+"&cost1km="+cost1km+"'><font color=blue>CarBooking</font></a>");
out.println("</td></tr>");
}out.println("</table>");
}
if(request.getParameter("days").equals("halfday")) 
   { 
   String day=request.getParameter("days");
   String city=request.getParameter("city");
   TransportDAO aTransportDAO=new TransportDAO(); 
  CoreHash aCoreHash=aTransportDAO.getHalfDayCars(day,city); 
 ...
 String carmodel=aTransportmodel.getCarmodel();
   ...
   double halfdaycost=aTransportmodel.getCosthalfday();
    out.println(halfdaycost);
out.println("</td>");
    out.println("<td>");
...
out.println(cost1km);
    out.println("</td><td>");
out.println("<a href='TransportBooking.jsp?Carname="+carname+"&carmodel="+carmodel+"&cost1day="+halfdaycost+"&cost1hr="+cost1hr+"&cost1km="+cost1km+"'><font color=blue>CarBooking</font></a>");
out.println("</td></tr>");
}out.println("</table>");
}
