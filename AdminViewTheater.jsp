    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        ...
        <tr> 
          ...
          <fieldset>
          <legend><strong>Admin Theaters</strong></legend>
...
<%@ page import="com.dts.project.model.*"%><%@ page import="com.dts.core.util.*" %>
       <%   
        ...
        Theaters atansport=new Theaters();
  CoreHash acorehash=atansport.viewAllTheaters();
   Enumeration aenumeration=acorehash.keys();
  %><table border="1" bordercolor="#660000">
         <tr bgcolor="#660033">
       <td><span class="style7">City</span></td>
       <td><span class="style7">TheaterName</span></td>
       <td><span class="style7">Cinema</span></td>
       <td><span class="style7">MorningShow</span></td>
       <td><span class="style7">MatnyShow</span></td>
       <td><span class="style7">FirstShow</span></td>
       <td><span class="style7">SecondShow</span></td>
       </tr>
  	 <%while(aenumeration.hasMoreElements())
   {
   Integer i1=(Integer)aenumeration.nextElement();
   Enterainement ahotelprofile=(Enterainement)acorehash.get(i1);
  %>
  <tr bordercolor="#660033" bgcolor="#FFFFCC"><td>
        		<span class="style8"><%=ahotelprofile.getCity()%></span></td><td>
        		  <span class="style8"><%=ahotelprofile.getTheatername()%></span></td><td>
        		    <span class="style8"><%=ahotelprofile.getCenima()%></span></td><td>
        		      <span class="style8"><%=ahotelprofile.getMorningshow()%></span></td><td>
        		        <span class="style8"><%=ahotelprofile.getMatnyshow()%></span></td><td>
        		          <span class="style8"><%=ahotelprofile.getFirstshow()%></span></td><td>
        		            <span class="style8"><%=ahotelprofile.getSecondshow()%></span></td><td>
