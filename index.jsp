...
<body topmargin="0" leftmargin="0" bgcolor="skyBlue" marginheight="0" marginwidth="0" text="#000000">
<!--
...
<table border="0" cellpadding="0" cellspacing="0" width="102%">
  <tbody><tr> 
    <td width="39%" bgcolor="#993300"><span class="style2"><font face="Verdana, Arial, Helvetica, sans-serif" size="2">Plan your trip here easily...........</font></span></td>
...
<table width="102%" height="0" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        <tbody> 
        <tr> 
          <td height="300" valign="top" width="651"><form name="form1" method="post" action="LoginAction.jsp">
          <fieldset>
  ...
  <%} %>
            ...
            <table width="294" border="0" align="center">
              <tr>
                <td width="89"><strong>UserName</strong></td>
                <td width="195"><label>
              ...
              <tr>
                <td>&nbsp;</td>
                <td><a href="Recoverpassword.jsp"><font color="#00CCFF">Forgot Password</font></a></td>
              </tr>
            </table>
            </fieldset>
                    </form>
