...
<table width="102%" height="0" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        <tbody> 
        <tr> 
          <td height="300" valign="top" width="651"><form name="form1" method="post" action="Transport1.jsp">
          <fieldset>
          <legend><strong>WELCOME TO THE TRANSAPORT</strong></legend>
 ...
 <table>
  ...
  String city1=(String)application.getAttribute("city");
   ...
   if(city!=null)
  {%>
  <h2>WELCOME TO THE <%=request.getParameter("city").toUpperCase() %> TRANSPORT</h2>
  <input type="hidden" name="city" value="<%=request.getParameter("city")%>"/>
  <%}
 else if(city1!=null)
  {%>
  <h2>WELCOME TO THE <%=city1.toUpperCase() %> TRANSPORT</h2>
  ...
  <tr>
    ...
    <td>visakaPatanam</td>
    <td><input name="city" type="radio" value="VisakaPatanam"></td>
  </tr>
  <tr>
    <td>Tirupati</td>
  ...
  <h5>Rental Type</h5> 
  FullDay<input type="radio" name="days" value="Fullday"/><br/> <br>
  Half Day<input type="radio" name="days" value="halfday"/><br/><br/>
  <input type ="submit" name="car" value="FindCar"/>
  </form>
