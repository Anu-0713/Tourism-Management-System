...
<table width="102%" height="0" border="0" align="left" cellpadding="0" cellspacing="0">
    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        ...
        <tr> 
          ...
          <fieldset>
          <legend><strong>Transport Booking</strong></legend>
           <center>
 ...
 <%String carname=request.getParameter("Carname");	
  ...
  String carmodel=request.getParameter("carmodel");
   ...
   %>
   <form action="TransportBooking1.jsp" method="post">
   <table>
  <tr>
    <td>Loginid</td>
    <td><input type="text" name="tourid" value=<%=loginname %>></td>
  </tr>
  <tr>
    <td>FirstName</td>
  ...
  <input type="hidden" name="cost1day" value="<%=cost1day%>"/>
  <input type="hidden" name="cost1hr" value="<%=cost1hr%>"/>
  ...
  <tr>
    <td>No of Cars</td>
    <td><input name="car" type="text"></td>
  </tr>
  <tr>
    <td>Days</td>
...
<table><tr><td><input type="submit" name="Login" value="CarBooking"/></td></tr></table>
</form>
