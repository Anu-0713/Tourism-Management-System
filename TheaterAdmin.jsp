...
<table width="102%" height="0" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="419" width="677">
        <tbody> 
        <tr> 
          <td height="399" valign="top" width="651"><form name="form1" method="post" action="TheaterAdmin1.jsp">
          <fieldset>
          <legend><strong><font color="blue">THEATER ADMINISTRATION</font></strong></legend>
            <table width="247" border="0" align="center">
              <tr>
                <td width="89" bgcolor="#660033"><span class="style2">SNO</span></td>
                <td width="195"><label>
                  <input type="text" name="sno" id="sno">
                </label></td>
              </tr>
              <tr>
                <td nowrap bgcolor="#660033"><span class="style2">City</span></td>
                <td>  <select name="city">
              ...
              <tr>
                <td bgcolor="#660033"><span class="style2">Theatername</span></td>
                <td><input type="text" name="theatername" id="theatername"></td>
              </tr>
             <tr>
                                <td bgcolor="#660000"><span class="style2">Cinema</span></td>
                                <td><strong>
                                  <input type="text" name="cinema">
                                    </strong> </td>
             </tr>
   <tr>
                <td bgcolor="#660033"><span class="style2">MorningShow</span></td>
                <td><input type="text" name="morningshow" id="morningshow"></td>
              </tr>
              <tr>
                <td bgcolor="#660033"><span class="style2">MatnyShow</span></td>
                <td><input type="text" name="matnyshow" id="matnyshow"></td>
              </tr>
              <tr>
                <td bgcolor="#660033"><span class="style2">FirstShow</span></td>
                <td><input type="text" name="firstshow" id="firstshow"></td>
              </tr>
              <tr>
                <td bgcolor="#660033"><span class="style2">SecondShow</span></td>
                <td><input type="text" name="secondshow" id="secondshow"></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
              </tr>
             ...
             <input type="submit" name="theatersadd" value="TheatersAdding">           
            <input type="submit" name="theatersupdate2" value="TheatersUpdating">
            <input type="submit" name="theatersdelete" value="TheatersDelteting">
          
                    </form>
            <a href="AdminViewTheater.jsp"><font color="blue">ViewTheaters</font></a>
           </tr>
        </tbody> 
      </table>    </td>
