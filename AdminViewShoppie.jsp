...
<%@ page import="com.dts.project.model.*"%>  <%@ page import="com.dts.core.util.*" %>
       <%   
          ...
          ShoppingPlaces atansport=new ShoppingPlaces();
  CoreHash acorehash=atansport.viewAllShopes();
   Enumeration aenumeration=acorehash.keys();%>
  <table width="640" border="1" bordercolor="#660033">
    <tr bgcolor="#663333"><td><span class="style10">SNo</span></td>
    <td><span class="style10">City</span></td>
    <td><span class="style10">ShopName</span></td>
    <td><span class="style10">Area</span></td>
    <td><span class="style10">Famous</span></td>
    </tr>
  
  <%	 while(aenumeration.hasMoreElements())
   {
   Integer i1=(Integer)aenumeration.nextElement();
   Shopping ahotelprofile=(Shopping)acorehash.get(i1);
  out.println("<tr><td>");
  String sno=ahotelprofile.getSno();
  String city=ahotelprofile.getCity();
  String shopname=ahotelprofile.getShopname();
  String area=ahotelprofile.getArea();
  String famous=ahotelprofile.getFamous();
  String discount=ahotelprofile.getDiscount();
  %>
  
  <tr bordercolor="#663366"><td><span class="style11"><%= city%></span></td>
  <td><span class="style11"><%=shopname %></span></td>
  
  <td><span class="style11"><%=area %></span></td>
  <td><span class="style11"><%=famous %></span></td>
  <td><span class="style11"><%=discount %></span></td></tr>
  <% }
