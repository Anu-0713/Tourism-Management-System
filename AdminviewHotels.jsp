...
.style11 {color: #FFFFFF; font-weight: bold; font-size: 16px; }
...
<%@ page import="com.dts.project.model.*"%>  <%@ page import="com.dts.core.util.*" %>
  <%@ page import="java.util.*" %>
  <%
  HotelBookingDAO ahotelbookingdao=new HotelBookingDAO();
  CoreHash acorehash=ahotelbookingdao.viewHotelDetails();
   Enumeration aenumeration=acorehash.keys();
  %><table width="649" border="1" bordercolor="#993300" ><tr><td width="69" bgcolor="#993300"><div align="center" class="style11">Hotelid</div></td>
  <td width="80" bgcolor="#993300"><div align="center" class="style11">City</div></td>
  <td width="107" bgcolor="#993300"><div align="center" class="style11">HotelName</div></td>
  <td width="106" bgcolor="#993300"><div align="center" class="style11">MaxPriice</div></td>
  <td width="253" bgcolor="#993300"><div align="center" class="style11">MinPrice</div></td>
 <!-- <td bgcolor="#993300"><div align="center" class="style11">NoofRooms</div></td>
   <td bgcolor="#993300"><div align="center" class="style11">room1type</div></td>
  <td bgcolor="#993300"><div align="center" class="style11">room1typecost</div></td>
   <td bgcolor="#993300"><div align="center" class="style11">room2type</div></td>
  <td bgcolor="#993300"><div align="center" class="style11">roomtype2cost</div></td>
  <td bgcolor="#993300"><div align="center" class="style11">roomtype3</div></td>
   <td bgcolor="#993300"><div align="center" class="style11">roomtype3cost</div></td>-->
   </tr>
  <%
     String id = "";
	 String city = "";
   ...
   HotelProfile ahotelprofile=(HotelProfile)acorehash.get(i1);
   id=ahotelprofile.getHotelid();
   city = ahotelprofile.getCity();
   name = ahotelprofile.getHotel();
   price = ahotelprofile.getMaxprice();
  %><tr><td><div align="center"><%=id%></div></td>
        		<td><%=city%></td>
        		 <td><%=name%></td>
        		  <td><div align="center"><%=price%></div></td>
        		  <td><div align="center"><span class="style12"><%=ahotelprofile.getMinprice()%></span></div></td>
        		<!--   <td><%=ahotelprofile.getNoofrooms()%></td>
        		  <td><%=ahotelprofile.getRoomtype1()%></td>
        		  <td><%=ahotelprofile.getRoomtype1cost()%></td>
        		<td><%=ahotelprofile.getRoomtype2()%></td> 
        		  <td><%=ahotelprofile.getRoomtype2cost()%></td>>
        		  <td><%=ahotelprofile.getRoomtype3()%></td> 
        		  <td><%=ahotelprofile.getRoomtype3cost()%></td> -->
				  </tr>
        		<% }%>
        		 </table>
