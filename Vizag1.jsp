   <html><body><center>                  <td width="75%" valign="top" align="left">
                    &nbsp;
                 <html><head>
...
<table width="102%" height="0" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        ...
        <tr> 
          ...
          <fieldset>
          <legend><strong>WELCOME TO THE VIZAG</strong></legend>
   ...
   <table border="0" width="100%" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td width="100%"><img border="0" src="images/main-destinations-vizag.jpg" width="570" height="240"></td>
                      </tr>
                      <tr>
                        <td width="100%">
 ...
 <body>
   ...
   %>
    <table><tr><td>
1.<% out.println("<a href='FindHotel.jsp?city="+city+"'><font color=blue>Accomadation</font></a>");%><br><br>
</td></tr><tr><td>2.<a href="Vizag2.jsp"><font color=blue>Places Of Interst</font></a><br><br></td></tr>
<tr><td>3.<% out.println("<a href='Shopping.jsp?city="+city+"'><font color=blue>Shopping</font></a>");%><br><br></td></tr>
<tr><td>4.<% out.println("<a href='Theater.jsp?city="+city+"'><font color=blue>Enterainement</font></a>");%><br><br></td></tr>
<tr><td>5.<% out.println("<a href='TourGuide.jsp?city="+city+"'><font color=blue>TourGuide</font></a>");%></td></tr>
<tr><td>6.<% out.println("<a href='Transport.jsp?city="+city+"'><font color=blue>Transport</font></a>");%></td></tr></table>
