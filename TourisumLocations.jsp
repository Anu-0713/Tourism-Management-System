...
<table width="102%" height="0" border="0" align="left" cellpadding="0" cellspacing="0">
    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        ...
        <tr> 
          ...
          <fieldset>
          <% %>
          <legend><strong>TOURIST LOCATIONS  </strong></legend>
 ...
 <center>
  ...
  CoreHash acorehash=atourlocation.viewTourLocations();
   ...
   out.println("<table border='1' width='100%'><tr><td ><font color=blue>City</font></td><td><font color=blue>State</font></td><td><font color=blue>Country</font></td><br/><br/><td><font color=blue>Pin</font></td></tr>");
   ...
   out.println("<a href='Places.jsp?city="+city+"'><font color=blue>"+atourlocations.getCity()+"</font></a>");
   out.println("</td><td>");
