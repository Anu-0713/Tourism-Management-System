    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        ...
        <tr> 
          ...
          <fieldset>
          <legend><strong>Welcome To The Shopping Places</strong></legend>
...
ShoppingPlaces ashopingplaces=new ShoppingPlaces();
CoreHash acorehash=ashopingplaces.viewShopes(city);
 Enumeration aenumeration=acorehash.keys();
 out.println("<table><tr><td>S.no</td><td>City</td><td>Shopname</td><td>Area</td><td>Famous</td><td>Discount</td></tr>");
 while(aenumeration.hasMoreElements())
 {
 Integer i1=(Integer)aenumeration.nextElement();
 Shopping ashopping=(Shopping)acorehash.get(i1);
 out.println("<tr><td>");
 out.println(ashopping.getSno());
 out.println("</td><td>");
 out.println(ashopping.getCity());
 out.println("</td><td>");
 out.println(ashopping.getShopname());
 out.println("</td><td>");
out.println(ashopping.getArea());
 out.println("</td><td>");
out.println(ashopping.getFamous());
 out.println("</td><td>");
out.println(ashopping.getDiscount());
 out.println("</td></tr>");
 }
 out.println("</table>");

 %>     <a href="TourisumLocations.jsp">Home</a><br>
