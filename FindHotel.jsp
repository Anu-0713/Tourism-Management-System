...
<table border="0" cellpadding="0" cellspacing="0" height="58" width="98%">
  ...
  <tr bgcolor="#ff9900"> 
    ...
    <table width="963" border="0" align="left">
      <tr>
        <td>   <jsp:include page="usermenu.html"/>       </td>
      </tr>
    </table>
    </div></td>
  </tr>
  ...
  <tr>
    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        <tbody> 
        <tr> 
          <td height="300" valign="top" width="651"><form action="RoomDetails1.jsp" method="get" name="register">
          <fieldset>
          <legend><strong>Find Hotel </strong></legend>
          
<table>
  
  <%
   String city1=(String)application.getAttribute("city");
 
   if(request.getParameter("city")!=null)
  {%>
  <h2>WELCOME TO THE <%=request.getParameter("city").toUpperCase() %> HOTELS</h2>
  <input type="hidden" name="city" value="<%=request.getParameter("city")%>"/>
  <%}
 else if(city1!=null)
  {%>
  <h2>WELCOME TO THE <%=city1.toUpperCase() %> HOTELS</h2>
  ...
  <tr>
    <td>Hyderbad</td>
    <td><input name="city" type="radio" value="Hyderbad"></td>
    <td>Vijayawada</td>
    <td><input name="city" type="radio" value="Vijayawada"></td>
    <td>visakaPatanam</td>
    <td><input name="city" type="radio" value="Vizag"></td>
  </tr>
  <tr>
    <td>Tirupati</td>
    <td><input name="city" type="radio" value="Tirupati"></td>
    <td>Warangal</td>
    <td><input name="city" type="radio" value="Warangal"></td>
    <td>NagarajunSagar</td>
    <td><input name="city" type="radio" value="NagarajunSagar"></td>
  </tr>
  <tr><td>PuttaParthy</td><td><input name="city" type="radio" value="PuttaParthy"></td></tr>
  <%} %>
</table>
<table>
  <tr>
    <td>Checkin</td>
    <td><input name="abc1" type="text" size="17"></td><td><a href="javascript:show_calendar('document.register.abc1', document.register.abc1.value);">
<img src="images/cal.gif" width="18" height="18" border="0"/></a></td>
  </tr>
  <tr>
    <td>Checkout</td>
    <td><input name="abc2" type="text" size="17"></td><td><a href="javascript:show_calendar('document.register.abc2', document.register.abc2.value);">
<img src="images/cal.gif" width="18" height="18" border="0"/></a></td>
 
  </tr>
  <tr>
    <td>Pricernage</td>
    <td><select name="pricerange"><option value="" selected>Selectedrangs</option><option value="1000">upTo1,000</option><option value="3000">up to 3000</option><option value="5000">up to 5000</option><option value="5000">Above 5000</option></select></td>
  </tr>
  <tr>
    <td>No Of Rooms</td>
    <td><input name="roomno" type="text" size="17"></td>
  </tr>
  <tr>
    <td>Adults</td>
...
</table><table><tr><td><input name="Login" type="submit" value="FindHotel">
