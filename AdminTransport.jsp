...
<table width="102%" height="0" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
        ...
        <tr> 
          ...
          <legend><strong>ADD TRANSAPORT</strong></legend>
            <table width="294" border="0" align="center">
              <tr>
                <td width="89" bgcolor="#660000"><span class="style2">Tour Organisation id</span></td>
                <td width="195"><label>
                  <input type="text" name="tid" id="tid">
                </label></td>
              </tr>
            <tr>
                                <td bgcolor="#660000"><span class="style2">City</span></td>
                                <td>
                                  <select name="city">
    ...
    <tr>
                <td bgcolor="#660000"><span class="style2">CarName</span></td>
                <td><input type="text" name="carname" id="carname"></td>
              </tr>
              <tr>
                <td bgcolor="#660000"><span class="style2">CarModel</span></td>
                <td><input type="text" name="carmodel" id="carmodel"></td>
              </tr>
              <tr>
                <td bgcolor="#660000"><span class="style2">Cost1Day</span></td>
                <td><input type="text" name="cost1day" id="cost1day"></td>
              </tr>
              <tr>
                <td bgcolor="#660000"><span class="style2">CostHalfDay</span></td>
                <td><input type="text" name="costhalfday" id="costhalfday"></td>
              </tr>
           <tr>
                <td bgcolor="#660000"><span class="style2">Cost1hr</span></td>
                <td><input type="text" name="cost1hr" id="cost1hr"></td>
              </tr>
           <tr>
                <td bgcolor="#660000"><span class="style2">Cost1km</span></td>
                <td><input type="text" name="cost1km" id="cost1km"></td>
              </tr>
           <tr bgcolor="#660000">
           ...
           <tr bgcolor="#660000">
            ...
            </table><A href="AdminViewTransport.jsp"><font color="blue">ViewTransport</font></A>
            <input type="submit" name="AddTransport" value="AddTransport">
            <input type="submit" name="UpdateTransport" value="UpdateTransport">
            <input type="submit" name="deleteTransport" value="DeleteTransport">
          </fieldset>
                    </form>
          </td>
          </tr>
