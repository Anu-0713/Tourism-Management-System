...
<table width="102%" height="0" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="66%" height="320" valign="top"> 
      <table align="center" bgcolor="#ffffcc" border="0" bordercolor="#ffffff" cellpadding="3" cellspacing="10" height="320" width="677">
        ...
        <tr> 
          ...
          <fieldset>
          <legend><strong>WELCOME TO THE TIRUPATI</strong></legend>
   ...
   %>
    ...
    <table><tr><td>
    <div align="right"><image src="pictures/tirupati.gif"></div>
1.<% out.println("<a href='FindHotel.jsp?city="+city+"'><font color=blue>Accomadation</font></a>");%><br><br>
</td></tr><tr><td>2.<a href="Tirupati.jsp"><font color=blue>Places Of Interst</font></a><br><br></td></tr>
